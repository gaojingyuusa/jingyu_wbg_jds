...
```{r echo=FALSE, warning =FALSE}
  ...
  wld_point <- na.omit(subset(san_dat_merge, income != "HIC",   select=c("region","income_id","name","year","sani_value")))
  wld_point <- wld_point[wld_point$year==2015 | wld_point$year==1995,]
  wld_point <- na.omit(reshape(wld_point,
         idvar = c("name","income_id","region"),
         timevar =  "year",
         direction = "wide"))
  
  wld_point$dif <- wld_point$sani_value.2015-wld_point$sani_value.1995
